...
namespace E_commerce.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260401171753_ConvertAppUserPropertyToOptionall")]
    partial class ConvertAppUserPropertyToOptionall
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("E_commerce.Core.Entities.Address", b =>
                {
                    b.HasOne("E_commerce.Core.Entities.AppUser", "AppUser")
                        .WithOne("Address")
                        .HasForeignKey("E_commerce.Core.Entities.Address", "AppUserId")
